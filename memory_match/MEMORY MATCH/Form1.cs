...
namespace MEMORY_MATCH
{
    public partial class MainOption : Form
    {
        ...
        {
            EventClick();
            Exit exitForm = new Exit(this, maingame); // Khởi tạo form Exit trước
            Play play = new Play(maingame, exitForm); // Truyền tham chiếu tới form Exit vào form Play
            play.Show();
        }
        ...
        private void btn_exit_Click(object sender, EventArgs e)
        {
            ...
            Exit exit = new Exit(this, maingame);
            exit.Show();
        }
